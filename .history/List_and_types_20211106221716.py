...
print(numbers[::])  # This will give the numbers list //
print(numbers[::2])  # This will give the numbers list after skipping the two elements in between //
print(numbers[::-1]) # This will give the numbers list in the reverse order 
print(numbers[1:5:-1]) # This will give the empty list 

# Note  : Always use -1 for negatuve slicing , none rather than that 

# Important functions : 

# Append function :
numbers.append(7)  # This will add 7 at the end 
print(numbers)
# Insert function :
numbers.insert(0,4) # This will insert the given numnber at the given index 
print(numbers)
#pop function
numbers.pop() # Chop off the last element 
