...
h = "harry"
print(h[0]) # This is one method through which we can print the character

# Another method for doing this :

ier = iter(h) # ier is an instance of iter method 
print(ier.__next__) # This is one method through which we can print the fist character
print(ier.__next__) # This is one method through which we can print the fist character
print(ier.__next__) # This is one method through which we can print the fist character
