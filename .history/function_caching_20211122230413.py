...
if __name__ == '__main__':
    ...
    some_work(3)   # After using the lru cache , this will undergo a 3 seconds delay but after that , it will execute the next call immediately because the prvious 3 values are saved in the cache
