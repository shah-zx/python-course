f = open("shahnawaz.txt" , "r")  # This will open the txt file and return the pointer which will help in different operations and alo provided with a specific mode 
