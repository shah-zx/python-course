...
class Employee:
    no_of_leaves = 10
    __init__(self , aname , asalary , aposition , agrade ):    # This is the init function which helps us in making the consructor and it takes the arguments
        self.name = name     # Now this self will automatically change to the object of the class in which the name variable can be initialized as names
