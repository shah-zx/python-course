...
# Bsically here we are handling the exception saying that first we are tring for variable c whereas we are printing a
# Secondly we are trying for a string say harry which is blocked. 
